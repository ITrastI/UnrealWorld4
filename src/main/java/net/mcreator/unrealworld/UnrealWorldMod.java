 ...
 *
 */
package net.mcreator.unrealworld;
...
@Mod("unreal_world")
public class UnrealWorldMod {
	public static final Logger LOGGER = LogManager.getLogger(UnrealWorldMod.class);
	public static final String MODID = "unreal_world";

	public UnrealWorldMod() {
