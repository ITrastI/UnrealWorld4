...
public class Modelcustom_model<T extends Entity> extends EntityModel<T> {
	...
	public final ModelPart Leftarmor2;
	public final ModelPart Grud;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Leftarmor = partdefinition.addOrReplaceChild("Leftarmor",
				CubeListBuilder.create().texOffs(24, 40).addBox(2.0F, -3.0F, -2.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(34, 72)
		...
		PartDefinition Leftarmor2 = partdefinition.addOrReplaceChild("Leftarmor2",
				CubeListBuilder.create().texOffs(0, 45).addBox(2.0F, -3.0F, -2.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 72)
						...
						.addBox(3.0F, 10.0F, -2.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(33, 105).addBox(4.0F, 7.0F, -2.0F, 1.0F,
		...
		PartDefinition Grud = partdefinition.addOrReplaceChild("Grud",
				CubeListBuilder.create().texOffs(44, 97).addBox(-2.0F, -1.46F, -0.692F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(22, 67)
		...
		PartDefinition osnova = partdefinition.addOrReplaceChild("osnova",
				CubeListBuilder.create().texOffs(16, 16).addBox(-4.0F, -24.0F, -3.0F, 8.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 32)
		...
		PartDefinition cube_r1 = osnova.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(12, 95).addBox(0.0F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(14, 69)
						.addBox(-2.0F, -1.5F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(42, 81)
						.addBox(-1.0F, 0.5F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 95).addBox(-2.0F, 2.5F, -0.5F, 3.0F,
		...
		PartDefinition cube_r2 = osnova.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(16, 95).addBox(-1.0F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(14, 67)
						.addBox(-1.0F, -1.5F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(48, 81)
						.addBox(-1.0F, 0.5F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(20, 95).addBox(-1.0F, 2.5F, -0.5F, 3.0F,
								1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, -15.5F, -3.0F, 0.0F, 0.3927F, 0.0F));
