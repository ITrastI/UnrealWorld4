...
public class ModelNagrudnik<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("unreal_world", "model_nagrudnik"), "main");
	public final ModelPart osnova;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition osnova = partdefinition.addOrReplaceChild("osnova", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition cube_r1 = osnova.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(40, 93).mirror().addBox(3.0F, 5.35F, 2.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(12, 45).mirror().addBox(2.0F, 5.85F, -1.5F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(8, 93)
						.mirror().addBox(3.0F, 5.35F, -2.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(4, 91)
						.addBox(-4.0F, 5.35F, 2.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(52, 91)
						.addBox(-4.0F, 5.35F, -2.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 40)
						...
						.addBox(-4.0F, 0.85F, -3.5F, 8.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(16, 16).addBox(-4.0F, -6.15F, -2.5F, 8.0F,
		...
		PartDefinition cube_r2 = osnova.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(12, 95).addBox(1.8149F, -3.15F, -3.9577F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(14, 69).addBox(-0.1851F, -2.15F, -3.9577F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(42, 81)
		...
		PartDefinition cube_r3 = osnova.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(16, 95).addBox(-2.8149F, -3.15F, -3.9577F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(14, 67).addBox(-2.8149F, -2.15F, -3.9577F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(48, 81)
				...
				PartPose.offsetAndRotation(0.0F, 6.0F, 0.0F, 0.0F, 0.3923F, 3.1235F));
		PartDefinition right = partdefinition.addOrReplaceChild("right", CubeListBuilder.create(), PartPose.offset(5.2143F, 2.8405F, 0.5F));
		PartDefinition cube_r4 = right.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(21, 107).mirror().addBox(-9.0F, -7.15F, -1.5F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(33, 105).mirror().addBox(-9.0F, -6.15F, -1.5F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(28, 32).mirror().addBox(-10.0F, 1.85F, -1.5F, 1.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(24, 50).mirror().addBox(-9.0F, 4.85F, -1.5F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(28, 72).mirror().addBox(-6.0F, 3.85F, 2.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(18, 83).mirror().addBox(-8.0F, 1.85F, 2.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(24, 72).mirror().addBox(-9.0F, 1.85F, 2.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(12, 62).mirror().addBox(-8.0F, 2.85F, 2.5F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(40, 93).mirror().addBox(-5.0F, 5.35F, 2.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(16, 93).mirror().addBox(-5.0F, 4.85F, 3.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(30, 81).mirror().addBox(-6.0F, 3.85F, 3.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(6, 81)
						.mirror().addBox(-6.0F, 3.35F, 2.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(32, 93).mirror()
						.addBox(-10.0F, 1.85F, 2.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(24, 93).mirror()
						.addBox(-9.5F, 1.85F, 2.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(20, 93).mirror()
						.addBox(-7.0F, 2.85F, 3.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(6, 67).mirror()
						.addBox(-9.0F, 1.85F, 3.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(12, 81).mirror()
						.addBox(-8.0F, 1.35F, 2.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 93).mirror()
						.addBox(-10.0F, 1.35F, 1.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(48, 97).mirror()
						.addBox(-9.0F, 0.85F, 2.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(44, 72).mirror()
						.addBox(-10.0F, 0.85F, -0.5F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(52, 97).mirror()
						.addBox(-9.0F, 0.85F, -2.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(24, 81).mirror()
						.addBox(-6.0F, 3.35F, -2.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(12, 86).mirror()
						.addBox(-6.5F, 1.85F, 2.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(20, 86).mirror()
						.addBox(-6.5F, 1.85F, -2.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(18, 81).mirror()
						.addBox(-8.0F, 1.35F, -2.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(4, 93).mirror()
						.addBox(-10.0F, 1.35F, -1.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 67).mirror()
						.addBox(-10.5F, 2.85F, -0.5F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(58, 50).mirror()
						.addBox(-10.5F, 1.85F, -1.5F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(36, 93).mirror()
						.addBox(-10.0F, 1.85F, -2.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(28, 93).mirror()
						.addBox(-9.5F, 1.85F, -2.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(6, 69).mirror()
						.addBox(-9.0F, 1.85F, -3.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(44, 93).mirror()
						.addBox(-7.0F, 2.85F, -3.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(36, 81).mirror()
						.addBox(-6.0F, 3.85F, -3.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(12, 40).mirror()
						.addBox(-8.0F, 6.35F, -1.5F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(8, 93).mirror()
						.addBox(-5.0F, 5.35F, -2.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(12, 93).mirror()
						.addBox(-5.0F, 4.85F, -3.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(24, 83).mirror()
						.addBox(-8.0F, 1.85F, -2.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(12, 45).mirror()
						.addBox(-6.0F, 5.85F, -1.5F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(38, 72).mirror()
						.addBox(-6.0F, 3.85F, -2.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(18, 62).mirror()
						.addBox(-8.0F, 2.85F, -2.5F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(34, 72).mirror()
						.addBox(-9.0F, 1.85F, -2.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(24, 40).mirror()
		...
		PartDefinition left = partdefinition.addOrReplaceChild("left", CubeListBuilder.create(), PartPose.offset(-5.2143F, 2.8405F, 0.5F));
		PartDefinition cube_r5 = left.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(21, 107).addBox(7.0F, -7.15F, -1.5F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(33, 105)
						...
						.addBox(8.0F, 1.85F, -2.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(24, 40).addBox(6.0F, 5.85F, -1.5F, 2.0F,
