...
public class ModelSkyHelmet_Converted<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("unreal_world", "model_sky_helmet_converted"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(54, 28).addBox(-4.0F, -8.0F, -5.0F, 8.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(10, 33)
